...
4. Make sure your branch is up to date with main before submitting a PR
5. Make a PR with a short but complete description of the changes
...
## Coding Guidelines
- Keep the code clean
- Add comments so that I won't have to guess what this and that does.
...
- Explain how this would benefit the browser in the long term
- If you changed something from the OG code explain why
- If there are any ***MINOR*** bugs derived from the changes explain why you couldn't fix it and explain how severe it is.
- Add labels
- Be patient (we won't ignore you trust)
...
We're building a browser to connect the world, not to make humans fight even more.
...
**If you have a discord account please join the discord server there's a link on the description, why? So that you can talk with other contributors and let everyone vote whether that feature/change should be merged with main or not.**
